      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08)">
        <tr>
          <td style="background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);padding:32px 40px;text-align:center">
            ...
            <div style="font-size:13px;color:rgba(255,255,255,0.8);margin-top:6px">安全验证服务</div>
          </td>
        </tr>
        <tr>
          <td style="padding:36px 40px 20px">
            <div style="font-size:18px;font-weight:600;color:#1a1a2e;margin-bottom:16px">邮箱验证码</div>
            <div style="font-size:14px;color:#555;line-height:1.8">
              尊敬的用户您好，<br><br>
              您正在进行账户安全验证，以下是您的验证码：
            </div>
          </td>
        </tr>
        <tr>
          <td align="center" style="padding:8px 40px 24px">
            <div style="display:inline-block;background:linear-gradient(135deg,#667eea,#764ba2);color:#fff;font-size:32px;font-weight:700;letter-spacing:8px;padding:16px 40px;border-radius:8px">{{$code}}</div>
          </td>
        </tr>
        <tr>
