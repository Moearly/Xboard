...
class AdminRoute
{
    ...
    {
        $router->group([
            'prefix' => 'admin',  // 固定使用 'admin' 作为API前缀，因为前端统一使用 /api/v2/admin/*
            'middleware' => ['tenant', 'admin', 'log'],
        ], function ($router) {
            // Config
            $router->group([
                'prefix' => 'config'
            ...
            $router->group([
                ...
                $router->get('/getSystemLogDetail', [SystemController::class, 'getSystemLogDetail']);
